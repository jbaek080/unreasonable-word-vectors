...
def generate_vocabulary_lookups(vocabulary, save_filepath):
        ...
        with codecs.open(save_filepath, "w", "utf-8") as wf:
                ...
                for word in sorted_words:
                        ...
                        non_reverse_vocabulary[index] = word
                        # also write the word in the save file
                        wf.write(word + "\t" + str(vocabulary[word]) + "\n")
                        index += 1
        return reverse_vocabulary, non_reverse_vocabulary
